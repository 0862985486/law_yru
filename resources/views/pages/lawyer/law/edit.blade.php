...
<div class="card card-custom card-sticky" id="kt_page_sticky_card">
  ...
  <div class="card-header">
    <div class="card-title">
      <h3 class="card-label">
        แก้ใขการยกร่าง<i class="mr-2"></i>
      </h3>
    </div>
    <div class="card-toolbar">
      <a href="{{route('lawyer.index')}}" class="btn btn-light-primary font-weight-bolder mr-2">
  ...
  <div class="card-body">
    <form class="form" id="kt_form" action="{{action('LawyerController@update',$law->law_id)}}" method="POST" enctype="multipart/form-data">
      @csrf
      <div class="row">
        ...
        <div class="col-xl-8">
          ...
          <div class="my-5">
            ...
            <div class="form-group row">
              <label class="col-3">เสนอ</label>
              <div class="col-9">
              <select class="form-control form-control-solid" name="offer">
                  <option value="{{$law->offer}}">{{$law->offer}}</option>
          ...
          <div class="my-5">
            ...
            <div class="form-group row">
              ...
              <select class="form-control form-control-solid" name="type">
                  <option value="{{$law->type}}">{{$law->type_name->name_type}}</option>
                  @foreach($type as $row)
          ...
          <div class="my-5">
            ...
            <div class="form-group row">
              ...
              <div class="col-9">
              <input list="browsers" class="form-control form-control-solid" id="browser" name="name_id" value="{{$law->name_id}}" required>
          ...
          <div class="my-5">
            ...
            <div class="form-group row">
              ...
              <div class="col-9">
                <input class="form-control form-control-solid" name="law_name" type="text" value="{{$law->law_name}}" />
              </div>
            </div>
          </div>
          <div class="my-5">
            ...
            <div class="form-group row">
              ...
              <div class="col-9">
                <select name="year" id="year" class="form-control form-control-solid">
                    <option value="{{$law->year}}">{{$law->year}}</option>
                    <?php for ($i = 0; $i <= 30; $i++) {?>
          ...
          <div class="my-5">
            ...
            <div class="form-group row">
              ...
              <div class="col-9">
                <input class="form-control form-control-solid" name="date_out" type="date" value="{{$law->date_out}}" />
              </div>
            </div>
          </div>
          <!-- <div class="my-5">
            <h3 class=" text-dark font-weight-bold mb-10"></h3>
            <div class="form-group row">
              <label class="col-3">วันที่ออก</label>
              <div class="col-9">
                <input class="form-control form-control-solid" name="date_out" type="date" value="{{$law->date_out}}" />
              </div>
            </div>
          ...
          <!-- <div class="my-5">
            ...
            <div class="form-group row">
              ...
              <div class="col-9">
                <input class="form-control form-control-solid" name="date_announce" type="date" value="{{$law->date_announce}}" />
              </div>
            </div>
          </div> -->
          <!-- <div class="my-5">
            ...
            <div class="form-group row">
              ...
              <div class="col-9">
              <select class="form-control form-control-solid" name="stutas">
                    @if($law->stutas=='1')
