      ...
      <div class="col-xl-10">
        ...
        <div class="tab-content">
            <div class="tab-pane fade in active show" id="profile" >
                <form class="form" id="kt_form" action="report/lawyer" method="get" enctype="multipart/form-data"
                    target="_blank" >
            ...
            <div role="tabpanel" class="tab-pane fade" id="buzz">
                <form class="form" id="kb_form" action="report/excel1" method="GET" enctype="multipart/form-data"
                    target="">
                    <div class="my-12">
                                <h4>รายงานประจำปี</h4>
                                <br>
