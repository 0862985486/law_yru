...
<div class="card card-custom card-sticky" id="kt_page_sticky_card">
  ...
  <div class="card-header">
    <div class="card-title">
      <h3 class="card-label">
        Update Department<i class="mr-2"></i>
      </h3>
    </div>
  ...
  <div class="card-body">
    <form class="form" id="kt_form" action="{{action('DepartmentController@update',$id)}}" method="POST" enctype="multipart/form-data">
      @csrf
      <div class="row">
        ...
        <div class="col-xl-8">
          ...
          <div class="my-5">
            ...
            <div class="form-group row">
              ...
              <div class="col-9">
                <input class="form-control form-control-solid" name="name" type="text" value="{{$department->name}}" />
              </div>
            </div>
          </div>
