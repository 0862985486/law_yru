...
<div class="card card-custom">
  <div class="card-header flex-wrap border-0 pt-6 pb-0">
    <div class="card-title">
      <h3 class="card-label">Purchase Request List
        <div class="text-muted pt-2 font-size-sm">Purchase Request Datatable </div>
      </h3>
    </div>
    <div class="card-toolbar">
      <!--begin::Button-->
      <a href="{{route('purchase-order.create')}}" class="btn btn-primary font-weight-bolder">
        <span class="svg-icon svg-icon-md">
          ...
          <!--end::Svg Icon-->
        </span>Create Purchase Request</a>
      <!--end::Button-->
    </div>
  </div>
  <div class="card-body">
