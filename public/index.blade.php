      ...
      <tbody>
              ...
              <tr>
                    ...
                    <div style="display:flex; flex-direction: row;">
                            <a href="{{action('LawController@edit',$row->id)}}" class="btn btn-warning btn-sm"><i class='far fa-edit'></i></a>
                            <a target ="_blank" href="{{asset('storage/law/'.$row->file_low)}}" class="btn btn-success btn-sm"><i class='far fa-file' style='font-size:20px'></i></a>
                            <form method="post" class="delete_form" action="{{action('LawController@destroy',$row->id)}}">{{csrf_field()}}
